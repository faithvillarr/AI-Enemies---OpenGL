...
public:
    ...
    void const check_deadly_collision(Entity* collidable_entities, int collidable_entity_count);
    ...
    void const scale(float scale_factor) { m_model_matrix = glm::scale(m_model_matrix, glm::vec3(scale_factor)); };
};